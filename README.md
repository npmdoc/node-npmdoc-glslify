...
#### api documentation for  [glslify (v6.0.2)](https://github.com/stackgl/glslify)  [![npm package](https://img.shields.io/npm/v/npmdoc-glslify.svg?style=flat-square)](https://www.npmjs.org/package/npmdoc-glslify) [![travis-ci.org build-status](https://api.travis-ci.org/npmdoc/node-npmdoc-glslify.svg)](https://travis-ci.org/npmdoc/node-npmdoc-glslify)
...
![npmPackageListing](https://npmdoc.github.io/node-npmdoc-glslify/build/screenCapture.npmPackageListing.svg)

![npmPackageDependencyTree](https://npmdoc.github.io/node-npmdoc-glslify/build/screenCapture.npmPackageDependencyTree.svg)
